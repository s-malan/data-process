"""
Encode audio files with different models and save these embeddings to be used in downstream tasks.
...
class EncodeAudio:
    ...
    def preemphasis(self, signal, coeff=0.97):
        """
        Perform preemphasis on the signal to be used for MFCCs.
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "model",
        help="available models (wav2vec2.0: HuggingFace, fairseq, hubert: HuggingFace, fairseq, hubert:main, melspec, mfcc)",
        choices=["w2v2_hf", "w2v2_fs", "hubert_hf", "hubert_fs", "hubert_shall", "melspec", "mfcc"],
        default="w2v2_hf",
    )
    parser.add_argument(
        "in_dir",
